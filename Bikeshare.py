...
def get_city():
    ...
    '''User Input for a city to return the filename for that city's bike share data.
    '''
...
def get_time_period():
    ...
    '''User Input for a time period and returns the specified filter.
    '''
...
def get_month():
    ...
    '''User Input for a month and returns the specified month.
    '''
...
def get_day():
    ...
    '''User Input for a day and returns the specified day.
    '''
    ...
    while valid_date == False:    
        ...
        while is_int == False:
            try:
                ...
                print('Sorry, I do not understand your input. Please type your response as an integer.')
                day = input('\nWhich day? Please type your response as an integer.\n')
        try:
...
def popular_day(df):
    ...
    '''Function to find and print the most popular day of week (Mon, Tue, etc.) for start time.
    '''
...
def popular_hour(df):
    ...
    '''Function to find and print the most popular hour of day for start time.
    '''
...
def trip_duration(df):
    ...
    '''Function to find and print the total trip duration and average trip duration
    '''
...
def popular_stations(df):
    ...
    '''Function to find and print the most popular start station and most popular end station.
    '''
...
def popular_trip(df):
    ...
    '''Function to find and print the most popular trip.
    '''
...
def users(df):
    ...
    '''Function to find and print the counts of each user type. 
    '''
...
def gender(df):
    ...
    '''Function to find and print the counts of gender. 
    '''
...
def birth_years(df):
    ...
    '''Function to find and print the earliest (i.e. oldest user), most recent (i.e. youngest user), and most popular birth years.
    '''
